...
class UpdateAlphabetRequest extends FormRequest
{
    /**
    ...
    {
        // Lấy ID của alphabet đang được cập nhật từ route parameter
        $alphabet = $this->route('alphabet');
        $alphabetId = $alphabet ? $alphabet->id : null;
        ...
        return [
            'character' => [
                ...
                'string',
                'max:10',
                // Unique: không được trùng character + type, nhưng ignore chính nó
